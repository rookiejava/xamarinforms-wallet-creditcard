...
#pragma warning restore 0219
        ...
        protected override void UpdateBackgroundColor(bool initialize)
        {
            ...
            {
                _evasMap = Interop.Evas.evas_map_new(4);
                Interop.Evas.evas_map_util_points_populate_from_object_full(_evasMap, _roundRectangle.Handle, 0);
                ...
                Interop.Evas.evas_map_point_color_set(_evasMap, 0, startColor.R, startColor.G, startColor.B, startColor.A);
                Interop.Evas.evas_map_point_color_set(_evasMap, 1, startColor.R, startColor.G, startColor.B, startColor.A);
                Interop.Evas.evas_map_point_color_set(_evasMap, 2, endColor.R, endColor.G, endColor.B, endColor.A);
                Interop.Evas.evas_map_point_color_set(_evasMap, 3, endColor.R, endColor.G, endColor.B, endColor.A);
                //Interop.evas_map_util_points_color_set(_evasMap, 255, 0, 0, 255);
                Interop.Evas.evas_object_map_set(_roundRectangle.Handle, _evasMap);
                Interop.Evas.evas_object_map_enable_set(_roundRectangle.Handle, true);
            }
        }
